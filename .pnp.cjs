...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "packageRegistryData": [\
      ...
      ["@dmeents/maestro", [\
        ["npm:1.1.1", {\
          "packageLocation": "./.yarn/cache/@dmeents-maestro-npm-1.1.1-a435d5561e-5c1f603a02.zip/node_modules/@dmeents/maestro/",\
          "packageDependencies": [\
            ["@dmeents/maestro", "npm:1.1.1"],\
            ["lodash", "npm:4.17.21"]\
          ],\
      ...
      ["npm", [\
        ["npm:8.15.0", {\
          "packageLocation": "./.yarn/unplugged/npm-npm-8.15.0-d766f9a6fd/node_modules/npm/",\
          "packageDependencies": [\
            ["npm", "npm:8.15.0"],\
            ["@isaacs/string-locale-compare", "npm:1.1.0"],\
            ["@npmcli/arborist", "npm:5.3.0"],\
